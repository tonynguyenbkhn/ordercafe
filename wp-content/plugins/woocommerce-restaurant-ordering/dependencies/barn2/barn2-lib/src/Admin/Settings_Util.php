...
class Settings_Util
{
    ...
    public static function get_help_links(Plugin $plugin)
    {
         ...
         * @since 1.1
         */
        $links = \apply_filters('barn2_plugin_settings_help_links', ['doc' => ['url' => $plugin->get_documentation_url(), 'label' => __('Documentation', 'woocommerce-restaurant-ordering'), 'target' => '_blank'], 'support' => ['url' => $plugin->get_support_url(), 'label' => __('Support', 'woocommerce-restaurant-ordering'), 'target' => '_blank']], $plugin);
