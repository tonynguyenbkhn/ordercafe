...
class License_Notices implements Registerable, Core_Service
{
    ...
    public function first_activation_notice()
    {
        ...
        \printf(
            ...
            __('Thank you for installing %1$s. To get started, please %2$s enter your license key%3$s.', 'woocommerce-restaurant-ordering'),
            $plugin_name,
    ...
    public function expired_license_notice()
    {
        ...
        \printf(
            ...
            __('Your license key for %1$s has expired. %2$sClick here to renew for 20%% discount%3$s.', 'woocommerce-restaurant-ordering'),
            $plugin_name,
    ...
    public function disabled_license_notice()
    {
        ...
        \printf(
            /* translators: 1: the plugin name, 2: renewal link start, 3: renewal link end. */
            __('You no longer have a valid license for %1$s. Please %2$spurchase a new license key%3$s to continue using the plugin.', 'woocommerce-restaurant-ordering'),
            $plugin_name,
    ...
    public function site_moved_notice()
    {
        ...
        \printf(
            /* translators: 1: the plugin name, 2: settings link start, 3: settings link end. */
            __('%1$s - your site has moved to a new domain. Please %2$sreactivate your license key%3$s.', 'woocommerce-restaurant-ordering'),
            $plugin_name,
            Util::format_link_open($this->plugin->get_license_page_url()),
            '</a>'
        );
